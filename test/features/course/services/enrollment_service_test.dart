...
void main() {
  ...
  group('EnrollmentService - getMyCourses', () {
    test('should return list of joined courses successfully', () async {
  ...
  // =================================================================
  group('EnrollmentService - getCourseEnrollment', () {
  ...
  // =================================================================
  group('EnrollmentService - enrollCourse', () {
    ...
    test('should return error when already enrolled', () async {
      // ARRANGE
      when(() => mockEnrollmentService.enrollCourse('course-1')).thenAnswer(
        (_) async => ApiRes<Enrollment>(
          status: 400,
    ...
    test('should return error when course is full', () async {
      // ARRANGE
      when(() => mockEnrollmentService.enrollCourse('course-full')).thenAnswer(
        (_) async => ApiRes<Enrollment>(
          status: 400,
          data: null,
  ...
  // =================================================================
  group('EnrollmentService - updateEnrollment', () {
    test('should update enrollment progress successfully', () async {
      // ARRANGE
    ...
    test('should update enrollment to completed status', () async {
      // ARRANGE
      when(() => mockEnrollmentService.updateEnrollment(any())).thenAnswer(
        (_) async => ApiRes<Enrollment>(
          status: 200,
    ...
    test('should return error when enrollment not found', () async {
      // ARRANGE
      when(() => mockEnrollmentService.updateEnrollment(any())).thenAnswer(
        (_) async => ApiRes<Enrollment>(
          status: 404,
    ...
    test('should return error when invalid lesson id', () async {
      // ARRANGE
